...
import { SuccessCircleIcon, CopyIcon } from "@flowagent-design/icon"
import { mergedToString } from "@flowagent-design/system"
...
function getCopyable(
  ...
  if (originCopyable.copyIcon == undefined) {
    originCopyable.copyIcon = (
      <CopyIcon color={globalColor(`--${flowagentPrefix}-grayBlue-01`)} />
    )
  }
  if (originCopyable.copiedIcon == undefined) {
    originCopyable.copiedIcon = (
      <SuccessCircleIcon color={globalColor(`--${flowagentPrefix}-green-03`)} />
    )
  }
