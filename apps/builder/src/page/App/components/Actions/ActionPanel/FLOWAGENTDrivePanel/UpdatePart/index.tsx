import { FLOWAGENTDriveUpdateContent } from "@flowagent-public/public-types"
...
export const UpdatePart: FC<FLOWAGENTDriveActionPartProps> = (props) => {
  const { t } = useTranslation()
  const commandArgs = props.commandArgs as FLOWAGENTDriveUpdateContent
