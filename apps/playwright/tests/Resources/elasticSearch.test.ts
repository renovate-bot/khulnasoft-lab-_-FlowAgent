...
test.describe("ElasticSearch create And delete", () => {
  ...
  test("create Resource", async ({ page }) => {
    ...
    await page
      .getByRole("textbox")
      .nth(1)
      .fill(process.env.FLOWAGENT_ELASTICSEARCH_HOST)
    await page
      .locator("div")
    ...
    await page
      ...
      .filter({ hasText: /^\*PortUpIconDownIcon$/ })
      .getByRole("textbox")
      .fill(process.env.FLOWAGENT_ELASTICSEARCH_PORT)
    await page.getByRole("textbox").nth(3).click()
    await page
      .getByRole("textbox")
      .nth(3)
      .fill(process.env.FLOWAGENT_ELASTICSEARCH_USERNAME)
    await page.locator('input[type="password"]').click()
    await page
      .locator('input[type="password"]')
      .fill(process.env.FLOWAGENT_ELASTICSEARCH_PASSWORD)
