...
import { buildIllaContextCompletionSource } from "./completionSources/flowagentContext"
...
const buildCompletionSources = (
  ...
  const flowagentSources = buildIllaContextCompletionSource(completionOptions)
  const completionSources: CompletionSource[] = [flowagentSources]
