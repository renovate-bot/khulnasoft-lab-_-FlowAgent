...
import { getCurrentUserId } from "@flowagent-public/user-data"
import { klona } from "klona/json"
import { get } from "lodash-es"
import { FC, MouseEvent, memo, useCallback, useContext, useMemo } from "react"
import { useTranslation } from "react-i18next"
import { useDispatch, useSelector } from "react-redux"
import { DropList, DropListItem, Dropdown } from "@flowagent-design/react"
...
const WrapperContainer: FC<WrapperContainerProps> = (props) => {
  ...
  const handleOnSelection = useCallback(
    (e: MouseEvent<HTMLDivElement>) => {
      ...
      e.stopPropagation()
      trackInEditor(FLOWAGENT_MIXPANEL_EVENT_TYPE.SELECT, {
        element: "component",
        parameter1: "click",
      })
