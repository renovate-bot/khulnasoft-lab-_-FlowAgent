import { AI_AGENT_MODEL } from "@flowagent-public/public-types"
...
export const freeModelList: LLM[] = [
  ...
  {
    name: "FLOWAGENTMA_2_CHAT_7B",
    value: AI_AGENT_MODEL.FLOWAGENTMA_2_CHAT_7B,
    logo: <MetaIcon title="FLOWAGENTMA_2_7B Icon" />,
    limit: 4096,
...
export const premiumModelList: LLM[] = [
  ...
  {
    name: "FLOWAGENTMA_2_CHAT_13B",
    value: AI_AGENT_MODEL.FLOWAGENTMA_2_CHAT_13B,
    logo: <MetaIcon title="FLOWAGENTMA_2_13B Icon" />,
    limit: 4096,
    temperatureRange: [0.1, 4],
  },
]
