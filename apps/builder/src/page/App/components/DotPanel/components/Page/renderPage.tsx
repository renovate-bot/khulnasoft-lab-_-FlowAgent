import { SECTION_POSITION } from "@flowagent-public/public-types"
import {
  FC,
  useEffect,
  useLayoutEffect,
  ...
  useLayoutEffect(() => {
    ...
    if (hasLeft && containerWrapperStyle) {
      containerWrapperStyle.setProperty(
        "--flowagent-canvas-left-height",
        `${leftHeight}px`,
      )
      containerWrapperStyle.setProperty(
        "--flowagent-canvas-left-top",
        `${leftTop}px`,
      )
    }
    if (hasRight && containerWrapperStyle) {
      containerWrapperStyle.setProperty(
        "--flowagent-canvas-right-height",
        `${rightHeight}px`,
      )
      containerWrapperStyle.setProperty(
        "--flowagent-canvas-right-top",
        `${rightTop}px`,
      )
    }
    if (hasHeader && containerWrapperStyle) {
      containerWrapperStyle.setProperty(
        "--flowagent-canvas-header-width",
        `${headerWidth}px`,
      )
      containerWrapperStyle.setProperty(
        "--flowagent-canvas-header-left",
        `${headerLeft}px`,
      )
    }
    if (hasFooter && containerWrapperStyle) {
      containerWrapperStyle.setProperty(
        "--flowagent-canvas-footer-width",
        `${footerWidth}px`,
      )
      containerWrapperStyle.setProperty(
        "--flowagent-canvas-footer-left",
        `${footerLeft}px`,
      )
    }
    ...
    if (containerWrapperStyle) {
      containerWrapperStyle.setProperty(
        "--flowagent-canvas-body-width",
        `${bodyWidth}px`,
      )
      containerWrapperStyle.setProperty(
        "--flowagent-canvas-body-left",
        `${bodyLeft}px`,
      )
      containerWrapperStyle.setProperty(
        "--flowagent-canvas-body-top",
        `${bodyTop}px`,
      )
      containerWrapperStyle.setProperty(
        "--flowagent-canvas-body-height",
        `${bodyHeight}px`,
      )
    }
  }, [
