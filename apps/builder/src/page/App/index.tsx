...
import { TriggerProvider, WarningCircleIcon } from "@flowagent-design/react"
...
export const Editor: FC = () => {
    ...
    return () => {
      ...
      dispatch(
        configActions.updateWSStatusReducer({
          context: FLOWAGENT_WEBSOCKET_CONTEXT.APP,
  ...
  useEffect(() => {
    track(
      ...
      FLOWAGENT_MIXPANEL_BUILDER_PAGE_NAME.EDITOR,
    )
    trackPageDurationStart()
    return () => {
      trackPageDurationEnd(FLOWAGENT_MIXPANEL_BUILDER_PAGE_NAME.EDITOR)
    }
  }, [])
  ...
  const combineLoadingState =
    loadingState ||
    wsStatus === FLOWAGENT_WEBSOCKET_STATUS.INIT ||
