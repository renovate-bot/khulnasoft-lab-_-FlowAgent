import { FLOWAGENTDriveDeleteOneContent } from "@flowagent-public/public-types"
...
export const DeleteOnePart: FC<FLOWAGENTDriveActionPartProps> = (props) => {
  const { t } = useTranslation()
  const commandArgs = props.commandArgs as FLOWAGENTDriveDeleteOneContent
