import { CodeEditor } from "@flowagent-public/code-editor"
import { AvatarUpload } from "@flowagent-public/cropper"
...
import {
  ...
  ShareAgentPC,
  ShareAgentTab,
} from "@flowagent-public/invite-modal"
import {
  freeModelList,
  getLLM,
  isPremiumModel,
  premiumModelList,
} from "@flowagent-public/market-agent"
import {
...
import { RecordEditor } from "@flowagent-public/record-editor"
...
export const AIAgent: FC = () => {
  ...
  const handleClickBack = () => {
    if (document.referrer.includes(import.meta.env.FLOWAGENT_CLOUD_URL)) {
      return (location.href = `${getFLOWAGENTCloudURL()}/workspace/${teamIdentifier}/ai-agents`)
    }
    if (
    ...
    return (location.href = getFLOWAGENTCloudURL())
  }
        ...
        <div css={leftPanelContainerStyle}>
          <div css={leftPanelCoverContainer}>
            <div css={leftPanelHeaderStyle}>
              ...
              <Link
                href="https://docs.flowagent.khulnasoft.com/ai-agent"
                target="__blank"
                ...
                render={({ field }) => (
                  ...
                  >
                    <Select
                      ...
                      onChange={(value) => {
                        track(
                          FLOWAGENT_MIXPANEL_EVENT_TYPE.CHANGE,
                          FLOWAGENT_MIXPANEL_BUILDER_PAGE_NAME.AI_AGENT_EDIT,
                          {
                            element: "model",
                            parameter1: value,
                  ...
                  >
                    {shareDialogVisible && (
                      <ShareAgentPC
                        ...
                        redirectURL={`${getFLOWAGENTBuilderURL()}/${
