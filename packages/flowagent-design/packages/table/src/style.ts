...
export function applyTdSelectedStyle(selected?: boolean) {
  ...
  return css`
    box-shadow: inset 0 0 0 1px ${globalColor(`--${flowagentPrefix}-blue-03`)};
  `
}
...
export const applyOverflowContentStyle = (
  ...
  return css`
    ...
    border: solid 1px ${globalColor(`--${flowagentPrefix}-blue-03`)};
    box-sizing: border-box;
  `
}
...
export const tableResizerStyle = css`
  ...
  &:hover {
    &:after {
      ...
      bottom: 0;
      right: 3px;
      background-color: ${globalColor(`--${flowagentPrefix}-grayBlue-06`)};
      width: 1px;
    }
  }
`
