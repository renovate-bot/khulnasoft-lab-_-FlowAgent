...
import { ShareAgentMobile } from "@flowagent-public/invite-modal"
import {
  MarketAIAgent,
  ...
  const dialog = (
    <Controller
      ...
      render={({ field }) => (
        <MixpanelTrackProvider
          basicTrack={track}
          pageName={FLOWAGENT_MIXPANEL_BUILDER_PAGE_NAME.AI_AGENT_RUN}
        >
          {shareDialogVisible && (
            <ShareAgentMobile
              ...
              redirectURL={`${getFLOWAGENTBuilderURL()}/${ownerTeamIdentifier}/ai-agent/${
                agent.aiAgentID
