...
export const selectoSelectionStyle = css`
  > .selecto-selection {
    ...
    transform: translate(
      var(--flowagent-select-area-left, 0),
      var(--flowagent-select-area-top, 0)
    ) !important;
    width: var(--flowagent-select-area-width, 0) !important;
    height: var(--flowagent-select-area-height, 0) !important;
