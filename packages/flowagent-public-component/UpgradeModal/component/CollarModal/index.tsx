...
import { Button, CloseIcon, Modal } from "@flowagent-design/react"
import { useCollarDrawer } from "../../hook"
import { CollarModalType } from "../../interface"
import { COFLOWAGENTR_UNIT_PRICE } from "../../service/interface"
    ...
    >
      ...
      <div>
        <div css={footerStyle}>
          <div>
            <div css={priceStyle}>
              {`$${COFLOWAGENTR_UNIT_PRICE[SUBSCRIPTION_CYCLE.MONTHLY]}`}
            </div>
