import { RedisResourceInitial } from "@flowagent-public/public-configs"
import { RedisResource, Resource } from "@flowagent-public/public-types"
...
import { Alert, Button, Divider, Input, getColor } from "@flowagent-design/react"
                    ...
                    <Trans
                      ...
                      components={[
                        <TextLink
                          ...
                          onClick={() => {
                            window.open(
                              "https://www.flowagent.khulnasoft.com/docs/flowagent-cli",
                              "_blank",
                            )
                          }}
                        />,
