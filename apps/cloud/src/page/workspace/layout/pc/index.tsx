import { PCCloudDashBoardLayout } from "@flowagent-public/cloud-dashboard-layout"
import { BottomList } from "@flowagent-public/cloud-dashboard-layout/components/BottomList"
...
import { useModal } from "@flowagent-design/react"
  ...
  useEffect(() => {
    if (
      ...
      modal.show({
        ...
        onOk: () => {
          window.open(
            `${getFLOWAGENTBuilderURL()}/${teamIdentifier}/guide?token=${getAuthToken()}`,
          )
        },
        afterOpen: () => {
