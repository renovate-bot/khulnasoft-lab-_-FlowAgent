...
import { Agent, GlobalDataActionContent } from "@flowagent-public/public-types"
        ...
        dropList={
          <DropList w="184px">
            <Item
              ...
              onClick={() => {
                trackInEditor(FLOWAGENT_MIXPANEL_EVENT_TYPE.RENAME, {
            ...
            <Item
              ...
              onClick={() => {
                trackInEditor(FLOWAGENT_MIXPANEL_EVENT_TYPE.DUPLICATE, {
            ...
            <Item
              ...
              deleted
              onClick={() => {
                trackInEditor(FLOWAGENT_MIXPANEL_EVENT_TYPE.DELETE, {
