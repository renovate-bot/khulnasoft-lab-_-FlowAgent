...
import { INIT_ACTION_MOCK_CONFIG } from "@flowagent-public/public-configs"
...
const FLOWAGENTDrivePanel = lazy(
  () => import("@/page/App/components/Actions/ActionPanel/FLOWAGENTDrivePanel"),
)
          ...
          <Suspense fallback={<WidgetLoading />}>
            ...
            {activeKey === "advanced" && (
              <MixpanelTrackProvider
                ...
                pageName={FLOWAGENT_MIXPANEL_PUBLIC_PAGE_NAME.PLACEHOLDER}
              >
                <AdvancedPanel />
              </MixpanelTrackProvider>
            )}
