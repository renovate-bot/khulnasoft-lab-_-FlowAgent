...
export const getPictureCardContainerStyle = (disabled: boolean) => {
  ...
  return css`
    ...
    &:hover {
      background-color: ${globalColor(`--${flowagentPrefix}-grayBlue-08`)};
    }
    &:active {
...
export const uploadProgressStyle = css`
  ...
  height: 16px;
  font-size: 16px;
  color: ${globalColor(`--${flowagentPrefix}-white-03`)};
`
...
export const pictureItemMask = css`
  ...
  background: ${globalColor(`--${flowagentPrefix}-blackAlpha-04`)};
  &:hover {
    opacity: 1;
    display: block;
  }
...
export const pictureItemOperationsStyle = css`
  ...
  align-items: center;
  gap: 10px;
  color: ${globalColor(`--${flowagentPrefix}-white-02`)};
`
...
export const errorImageContainerStyle = css`
  ...
  height: 100%;
  color: ${globalColor(`--${flowagentPrefix}-red-03`)};
  border: 1px solid ${globalColor(`--${flowagentPrefix}-red-03`)};
  border-radius: 4px;
  display: flex;
  flex-direction: column;
  justify-content: space-between;
