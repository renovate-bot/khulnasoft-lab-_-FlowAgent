...
import { getFLOWAGENTBuilderURL } from "@flowagent-public/utils"
import { formatDate } from "@flowagent-public/utils"
import { FC, useCallback, useState } from "react"
import { useTranslation } from "react-i18next"
import { useParams } from "react-router-dom"
import { Button, useMessage } from "@flowagent-design/react"
import { Signal } from "@/api/ws/FLOWAGENT_PROTO"
import {
  ModifyHistory,
  Snapshot,
  SnapshotTriggerMode,
...
export const SnapShotItem: FC<SnapShotListProps> = (props) => {
  ...
  const handleRecoverSnapShot = useCallback(async () => {
    ...
    try {
      ...
      window.location.href = `${getFLOWAGENTBuilderURL()}/${teamIdentifier}/app/${
        snapshot.appID
      }`
    } catch (error) {
