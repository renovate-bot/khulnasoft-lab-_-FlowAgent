...
export function applyCloseIcon(
  ...
  if (variant === "fill") {
    variantCss = css`
      &:hover {
        background-color: ${globalColor(`--${flowagentPrefix}-white-07`)};
      }
    `
    ...
    if (color === "gray" || color === "grayBlue") {
      variantCss = css`
        &:hover {
          background-color: ${globalColor(`--${flowagentPrefix}-${color}-08`)};
        }
      `
    }
  }
  ...
  return css`
    ...
    &:hover {
      background-color: ${globalColor(`--${flowagentPrefix}-${color}-06`)};
      cursor: pointer;
    }
...
export function tagOutlinePrepare(color: TagColorScheme): SerializedStyles {
  if (color == "gray" || color == "grayBlue") {
    return css`
      border-radius: 12px;
      border: solid 1px ${globalColor(`--${flowagentPrefix}-${color}-08`)};
...
export function tagLightPrepare(color: TagColorScheme): SerializedStyles {
  if (color == "grayBlue") {
    return css`
      border-radius: 12px;
      background-color: ${globalColor(`--${flowagentPrefix}-${color}-09`)};
      color: ${globalColor(`--${flowagentPrefix}-${color}-02`)};
    `
  } else {
    return css`
      border-radius: 12px;
