...
import { FLOWAGENTDriveActionPartProps } from "@/page/App/components/Actions/ActionPanel/FLOWAGENTDrivePanel/interface"
import { SingleTypeComponent } from "@/page/App/components/Actions/ActionPanel/SingleTypeComponent"
import { InputEditor } from "@/page/App/components/Actions/InputEditor"
import { VALIDATION_TYPES } from "@/utils/validationFactory"
import FolderSelect from "../components/FolderSelect"

export const ListAllPart: FC<FLOWAGENTDriveActionPartProps> = (props) => {
  const { t } = useTranslation()
  const commandArgs = props.commandArgs as FLOWAGENTDriveListAllContent
  ...
  return (
    <>
      ...
      />
      {filterType === FLOWAGENT_DRIVE_FILTER_TYPE.BY_NAME && (
        <InputEditor
      ...
      {filterType === FLOWAGENT_DRIVE_FILTER_TYPE.BY_ID && (
        <InputEditor
