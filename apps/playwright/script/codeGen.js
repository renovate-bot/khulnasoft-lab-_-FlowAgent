...
childProcess.execSync(`pnpm playwright codegen  ${process.env.FLOWAGENT_BUILDER_URL}/${process.env.FLOWAGENT_CLOUD_TEAM_IDENTITY}/dashboard/apps --load-storage=.auth/user.json --ignore-https-errors`)