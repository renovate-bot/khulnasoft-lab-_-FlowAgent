...
import { TriggerProvider } from "@flowagent-design/react"
...
export const DeployContent: FC = () => {
  ...
  useEffect(() => {
    track(
      ...
      FLOWAGENT_MIXPANEL_BUILDER_PAGE_NAME.DEPLOY,
    )
    trackPageDurationStart()
    return () => {
      trackPageDurationEnd(FLOWAGENT_MIXPANEL_BUILDER_PAGE_NAME.DEPLOY)
    }
  }, [])
