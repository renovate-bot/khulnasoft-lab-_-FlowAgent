...
export const labelTooltipStyle = css`
  &:after {
    background-image: repeating-linear-gradient(
      90deg,
      ${globalColor(`--${flowagentPrefix}-grayBlue-06`)} 0,
      ${globalColor(`--${flowagentPrefix}-grayBlue-06`)} 1px,
      transparent 0,
      transparent 3px,
      ${globalColor(`--${flowagentPrefix}-grayBlue-06`)} 0,
      ${globalColor(`--${flowagentPrefix}-grayBlue-06`)} 4px
    );
...
export const labelCaptionCss = css`
  overflow: hidden;
  color: ${globalColor(`--${flowagentPrefix}-gray-04`)};
  text-overflow: ellipsis;
`
