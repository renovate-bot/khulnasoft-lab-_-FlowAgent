...
export enum SUBSCRIBE_PLAN {
  ...
  COFLOWAGENT_FREE = "colla_free",
  COFLOWAGENT_SUBSCRIBE_PAID = "colla_subscribe_paid",
  COFLOWAGENT_SUBSCRIBE_INSUFFICIENT = "colla_subscribe_insufficient",
  COFLOWAGENT_SUBSCRIBE_CANCELED = "colla_subscribe_canceled",
  COFLOWAGENT_SUBSCRIBE_EXPIRED = "colla_subscribe_expired",
}
