import { MicrosoftSqlResourceInitial } from "@flowagent-public/public-configs"
import { MicrosoftSqlResource, Resource } from "@flowagent-public/public-types"
...
import { Alert, Divider, WarningCircleIcon, getColor } from "@flowagent-design/react"
...
const MicrosoftSqlConfigElement: FC<BaseConfigElementProps> = (props) => {
  ...
  const handleDocLinkClick = () => {
    window.open("https://www.flowagent.khulnasoft.com/docs/flowagent-cli", "_blank")
  }
