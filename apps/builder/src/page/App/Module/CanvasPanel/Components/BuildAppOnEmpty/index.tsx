...
import { CloseIcon, getColor, isObject } from "@flowagent-design/react"
...
const BuildAppOnEmpty: FC = () => {
  ...
  const shownApp = FLOWAGENTBuilderStorage.getLocalStorage(SHOWN_BUILD_APP)
  ...
  const handleCloseBuildApp = useCallback(() => {
    ...
    FLOWAGENTBuilderStorage.setLocalStorage(SHOWN_BUILD_APP, {
      ...localShownBuildApp,
      [appID]: true,
    })
  }, [appID])
  ...
  return (
    <>
      <MixpanelTrackProvider
        basicTrack={track}
        pageName={FLOWAGENT_MIXPANEL_BUILDER_PAGE_NAME.EDITOR}
      >
