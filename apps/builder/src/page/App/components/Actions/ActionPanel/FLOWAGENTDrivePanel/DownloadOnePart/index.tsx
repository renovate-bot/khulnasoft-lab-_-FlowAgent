import { FLOWAGENTDriveDownloadOneContent } from "@flowagent-public/public-types"
...
export const DownloadOnePart: FC<FLOWAGENTDriveActionPartProps> = (props) => {
  const { t } = useTranslation()
  const commandArgs = props.commandArgs as FLOWAGENTDriveDownloadOneContent
