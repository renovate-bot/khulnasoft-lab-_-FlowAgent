...
import { isString } from "@flowagent-design/react"
...
export const isDriveActionContent = (
  actionType: ActionType,
  actionContent: ActionContent,
): actionContent is FLOWAGENTDriveAction<FLOWAGENTDriveActionTypeContent> => {
  return (
    actionType === "flowagentdrive" &&
    "operation" in actionContent &&
    Object.values(FLOWAGENT_DRIVE_ACTION_REQUEST_TYPE).includes(
      actionContent.operation as FLOWAGENT_DRIVE_ACTION_REQUEST_TYPE,
    )
  )
}
