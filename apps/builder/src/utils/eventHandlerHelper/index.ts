...
export enum EVENT_ACTION_TYPE {
  ...
  SCRIPT = "script",
  DOWNLOAD_FROM_FLOWAGENT_DRIVE = "downloadFromFLOWAGENTDrive",
  SAVE_TO_FLOWAGENT_DRIVE = "saveToFLOWAGENTDrive",
}
...
export const transformEvents = (
  ...
  switch (actionType as EVENT_ACTION_TYPE) {
    ...
    case EVENT_ACTION_TYPE.DOWNLOAD_FROM_FLOWAGENT_DRIVE: {
      const { downloadInfo, asZip, enabled } = event
      return {
        script: () => {
          globalData.utils.downloadFromFLOWAGENTDrive({
            downloadInfo,
            asZip,
          })
        },
    ...
    case EVENT_ACTION_TYPE.SAVE_TO_FLOWAGENT_DRIVE: {
      const {
        fileName,
        fileData,
        fileType,
      ...
      return {
        script: () => {
          globalData.utils.saveToFLOWAGENTDrive({
            fileData,
            fileName,
            fileType,
            allowAnonymous,
