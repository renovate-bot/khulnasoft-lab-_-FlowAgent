import { INIT_ACTION_ADVANCED_CONFIG } from "@flowagent-public/public-configs"
import { ACTION_RUN_TIME } from "@flowagent-public/public-types"
...
export const getIsFLOWAGENTEditMode = (state: RootState) => {
  return state.config.mode === "edit" || state.config.mode === "template-edit"
}

export const getIsFLOWAGENTGuideMode = (state: RootState) => {
  return state.config.mode === "template-edit"
}

export const getIsFLOWAGENTPreviewMode = (state: RootState) => {
  return state.config.mode === "preview"
}

export const getIsFLOWAGENTProductMode = (state: RootState) => {
